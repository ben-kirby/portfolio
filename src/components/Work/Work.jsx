...
class Work extends React.Component {
	...
	render() {
		...
		return (
			<styles.Content>
				<styles.ButtonRow>
					<styles.WorkButtons onClick={this.handleMoveLeft}> ↢ </styles.WorkButtons>
					<styles.WorkButtons value='0' onClick={this.handleChangeContent}>1</styles.WorkButtons>
					<styles.WorkButtons value='1' onClick={this.handleChangeContent}>2</styles.WorkButtons>
					<styles.WorkButtons value='2' onClick={this.handleChangeContent}>3</styles.WorkButtons>
					<styles.WorkButtons onClick={this.handleMoveRight}> ↣ </styles.WorkButtons>
